label Slavia_previu:
    ...
    show text '{size=30}{color=#FF0800}{size=40}(!)ПРЕДУПРЕЖДЕНИЕ{/size}{/color}{p}{p}Это художестенное произведение.{p}Все персонажи, организации, меcта и события выдуманы{p} и не связаны с реальными лицами.{/size}': 
        center
        ypos 0.25
    with dissolve2
